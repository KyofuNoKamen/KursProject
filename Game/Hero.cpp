...
void Hero::heroSpriteFunction() {
    sf::Texture hero;
    if (!hero.loadFromFile("Resources/spr.png"/*,sf::IntRect(198, 34, 96, 128)*/))
    {
    ...
    std::cout << "draw hero sprite1" << std::endl;

    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left)) {
        heroSprite.move(-12, 0); heroSprite.setTextureRect(sf::IntRect(535, 341, -96, 134)); std::cout << "draw hero sprite mov" << std::endl;
    }
